...
import com.example.tuitlife.adapters.ViewPagerAdapter
import com.example.tuitlife.databinding.FragmentChatsAndGroupsBinding
import com.example.tuitlife.firebase.FirebaseService
...
class ChatsAndGroupsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentChatsAndGroupsBinding.inflate(inflater, container, false)
        root = binding.root
        FirebaseService.sharedPreference = requireContext().getSharedPreferences("sharedPref",
